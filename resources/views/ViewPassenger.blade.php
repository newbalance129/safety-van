            ...
            <div class="container-fluid" style="height:2000px">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-table"></i> List of Passenger
                                <div>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @foreach($passenger as $pas)
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><center>{{$pas->pIdCard}}</center></td>
                                        <td><center>{{$pas->pFName}} {{$pas->pLName}}</center></td>
                                        <td><center>{{$pas->roundCount}}</center></td>
                                        <td><center>{{$pas->seat}}</center></td>
                                        @endforeach
