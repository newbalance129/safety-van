...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="col-xs-8">
            ...
            <img class="slide-image" src="{{url('/img/minibus.png')}}" alt="">  
            @endif
                        <h2>National ID Card : {{$dv->dIdCard}}</h2><br>
                        <h2>Name : {{$dv->dFName}} {{$dv->dLName}}</h2></h2><br>
                        <h2>Date of Birth : {{$dv->dDob}}</h2><br>
                        <h2>Blood Type : {{$dv->dBlood}}</h2>
                    </div>
                </div>
